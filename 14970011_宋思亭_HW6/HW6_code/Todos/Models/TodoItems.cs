...
namespace Todos.Models
{
    public class TodoItem : INotifyPropertyChanged
    {
        ...
        public TodoItem(long ID, DateTime date, string imgname, string title = "", string details = "", bool? finish = false)
        {
            this.ID = ID;
            this.date = date;
        ...
        public void UpdateItem(DateTime date, string imgname, string title, string details)
        {
            this.title = title;
            this.details = details;
            this.date = date;
